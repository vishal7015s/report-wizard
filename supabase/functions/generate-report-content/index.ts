...
${prompt}`;
    ...
    const abstractAckPromise = (async () => {
      ...
      const isPlural = Array.isArray(students) && students.length > 1;

      const programmaticAcknowledgement = isPlural
        ? `We are thankful to the technical university Rajiv Gandhi Proudyogiki Vishwavidyalaya, Bhopal for giving us opportunity to convert our theoretical knowledge into the practical skills through this project.
