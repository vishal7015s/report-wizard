...
const ReportPreview = () => {
  ...
  return (
    <div className="animate-fade-in lg:h-[calc(100vh-120px)] lg:flex lg:flex-col lg:overflow-hidden">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 lg:gap-8 lg:flex-1 lg:min-h-0 lg:overflow-hidden">
        {/* Preview Area */}
        <div className="lg:col-span-2 lg:min-h-0 order-2 lg:order-1 lg:overflow-hidden">
          <div className="bg-muted/50 p-4 sm:p-8 rounded-xl overflow-auto max-h-[50vh] lg:max-h-none lg:h-full">
        ...
        {/* Sidebar */}
        <div className="space-y-6 order-1 lg:order-2 lg:overflow-auto">
